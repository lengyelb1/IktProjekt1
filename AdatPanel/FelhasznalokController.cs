...
{
    public class FelhasznalokController : Connection_Manager, ISQL
    {
        public List<Record> Select()
        {
            ...
            try
            {
                MySqlConnection connection = Connection_Manager.connection;
                connection.Open();
        ...
        public string Insert(Record record)
        {
            ...
            cmd.Connection = Connection_Manager.connection;
            try
            {
